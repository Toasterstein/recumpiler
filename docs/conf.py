...
version, release = find_version("..", "recumpiler", "__init__.py")
...
htmlhelp_basename = "recumpilerdoc"
...
latex_documents = [
    (master_doc, "recumpiler.tex", "recumpiler Documentation", author, "manual"),
]
...
man_pages = [
    (master_doc, "recumpiler", "recumpiler Documentation", author.split(", "), 1)
]
...
def run_apidoc(_):
    ...
    module = os.path.join(cur_dir, "..", "recumpiler")
    main(
        [
            "--module-first",
            "--separate",
